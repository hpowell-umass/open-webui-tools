...
class Tools:
    ...
    def normalize_arxiv_id(sself, arxiv_id: str) -> str:
    ...
    def resolve_inputs(self, tex_content: str, file_dict: Dict[str, str]) -> str:
        """
    ...
    def tex_to_markdown(self, tex_str: str) -> str:
        """
...
class TestArxivTool(unittest.TestCase):
    ...
    def test_search(self):
        ...
        result = self.tools.search_arxiv("Attention Is All You Need", max_results=1)
    ...
    def test_equation_conversion_inline(self):
        ...
        md = self.tools.tex_to_markdown(sample)
...
"""
    ...
    def test_full_markdown_conversion_actual_latex_paper(self):
        ...
        result = self.tools.get_paper_markdown("1706.03762")
    ...
    def test_pre_latex_pdf_paper(self):
        ...
        result = self.tools.get_paper_markdown("hep-th/9201001")
        self.assertIsNotNone(result)
    ...
    def test_non_existent_paper(self):
        ...
        result = self.tools.get_paper_markdown("9999.99999")
